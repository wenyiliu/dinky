...
import {
  ...
  KUBERNETES_CONFIG_NAME_LIST, TASK_COMMON_CONFIG_LIST
...
export function getConfig(values: any) {
  ...
  let taskCommonConfigList = addValueToMap(values, TASK_COMMON_CONFIG_LIST());
  addListToMap(values.flinkConfigList, flinkConfig);
  addListToMap(values.taskCommonConfigList, taskCommonConfigList);
  if (values.type == 'Yarn') {
...
export function getConfigFormValues(values: any) {
  ...
  let taskCommonConfigList = addMapToList(config.taskCommonConfigList, TASK_COMMON_CONFIG_LIST());
  return {
    ...formValues,
    ...configValues,
    ...hadoopConfig,

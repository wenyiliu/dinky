...
export default {
  ...
  'pages.rc.clusterConfig.commonConfig': 'Task 通用配置',
  'pages.rc.clusterConfig.otherConfig': '其他配置',
  'pages.rc.clusterConfig.addDefineConfig': '添加一个自定义项',
  'pages.rc.clusterConfig.addTaskCommonConfig': '添加一个 FlinSql 运行时通用配置',
  ...
  'pages.rc.alert.instance.Slack':'Slack 告警',
  'pages.rc.alert.instance.channel': 'channel',
  'pages.rc.alert.instance.webhookPleaseHolder': '请输入 webhook 地址',
  'pages.rc.alert.instance.keywordPleaseHolder': '请输入关键词',
  'pages.rc.alert.instance.channelPleaseHolder': '请输入channel',
